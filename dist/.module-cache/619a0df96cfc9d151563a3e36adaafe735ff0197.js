...
Calendar.LeftRail = React.createClass({displayName: "LeftRail",
            render: function() {
                ...
                for (; count <= flipPoint; count++, start++) {
                    ...
                    // main line
                    leftRail.push( React.createElement("div", {className: "timeBlock"}, " ", React.createElement("span", {className: "h4 pull-right"}, " ", 
                            currentHour, 
                        " "), React.createElement("span", {className: "h6 pull-right"}, flip?"PM" : "AM"), " "));

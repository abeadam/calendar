...
Calendar.MainContainer = React.createClass({displayName: "MainContainer",
    render: function() {
        return (React.createElement("div", {className: "calendarContainer row"}, 
                React.createElement(Calendar.LeftRail, {widthClass: "col-md-2 custom", defaults: this.props.railDefaults}), 
                React.createElement(Calendar.EventContainer, {widthClass: "col-md-10 custom"})
            ));
    }
});

...
Calendar.LeftRail = React.createClass({displayName: "LeftRail",
            render: function() {
                ...
                for (; count <= flipPoint; count++, start++) {
                    ...
                    // main line
                    leftRail.push( React.createElement("div", {className: "timeBlock pull-right"}, " ", React.createElement("span", {className: "h4"}, " ", 
                            currentHour, 
                    ...
                    if (!(flip && start % flipPoint == originalStart)) {
                            leftRail.push( React.createElement("div", {className: "timeBlock pull-right"}, " ", React.createElement("span", {className: "h6"}, " ", 
                                currentHour, 
                            ": 30 ")) );
                        }
                    }
...
Calendar.EventContainer = React.createClass({displayName: "EventContainer",
    render: function() {
        return (React.createElement("div", {className: "eventContainer"}))
    }
});
Calendar.MainContainer = React.createClass({displayName: "MainContainer",
    render: function() {
        return (React.createElement("div", {className: "calendarContainer row"}, 
                React.createElement(Calendar.LeftRail, {defaults: this.props.railDefaults, className: "col-md-2"}), 
                React.createElement(Calendar.EventContainer, {className: "col-md-10"})
            ));
    }
});
